...
abstract class ResponseData implements Built<ResponseData, ResponseDataBuilder> {
  @nullable
  int get code;
  ...
  String toJson() {
    return json.encode(serializers.serializeWith(ResponseData.serializer, this));
  }
