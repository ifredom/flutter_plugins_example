...
class _$UserSerializer implements StructuredSerializer<User> {
  ...
  Iterable<Object> serialize(Serializers serializers, User object,
    ...
    if (object.headImageUrl != null) {
      result
        ..add('headImageUrl')
        ..add(serializers.serialize(object.headImageUrl,
            specifiedType: const FullType(String)));
    }
    ...
    if (object.musicNoteNum != null) {
      result
        ..add('musicNoteNum')
        ..add(serializers.serialize(object.musicNoteNum,
            specifiedType: const FullType(int)));
    }
    if (object.musicStoneNum != null) {
      result
        ..add('musicStoneNum')
        ..add(serializers.serialize(object.musicStoneNum,
            specifiedType: const FullType(int)));
    }
    if (object.studentNum != null) {
      result
        ..add('studentNum')
        ..add(serializers.serialize(object.studentNum,
            specifiedType: const FullType(int)));
    }
    if (object.teachingNum != null) {
      result
        ..add('teachingNum')
        ..add(serializers.serialize(object.teachingNum,
            specifiedType: const FullType(int)));
    }
    if (object.alipayAccount != null) {
      result
        ..add('alipayAccount')
        ..add(serializers.serialize(object.alipayAccount,
            specifiedType: const FullType(String)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'teamName':
          ...
          break;
        case 'headImageUrl':
          result.headImageUrl = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'accountBalance':
          ...
          break;
        case 'musicNoteNum':
          result.musicNoteNum = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'musicStoneNum':
          result.musicStoneNum = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'studentNum':
          result.studentNum = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'teachingNum':
          result.teachingNum = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'alipayAccount':
          result.alipayAccount = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
      }
    }
...
class _$User extends User {
  ...
  @override
  final int musicNoteNum;
  @override
  final int musicStoneNum;
  @override
  final int studentNum;
  @override
  final int teachingNum;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is User &&
        ...
        musicNoteNum == other.musicNoteNum &&
        musicStoneNum == other.musicStoneNum &&
        studentNum == other.studentNum &&
        teachingNum == other.teachingNum &&
                            ...
                            $jc(
                                $jc(
                                    $jc(
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), token.hashCode), mobile.hashCode), nickName.hashCode), gender.hashCode), age.hashCode), provice.hashCode), city.hashCode), area.hashCode), vipFlag.hashCode), userType.hashCode), validFlag.hashCode), deleteFlag.hashCode), createBy.hashCode), createTime.hashCode), updateBy.hashCode), updateTime.hashCode), proviceId.hashCode), cityId.hashCode), regionId.hashCode), realName.hashCode), levelCode.hashCode), pwd.hashCode),
                                                                                birthday.hashCode),
                                        ...
                                        country.hashCode),
                                    teamName.hashCode),
                                headImageUrl.hashCode),
                            accountBalance.hashCode),
                        musicNoteNum.hashCode),
                    musicStoneNum.hashCode),
                studentNum.hashCode),
            teachingNum.hashCode),
        alipayAccount.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper('User')
          ...
          ..add('headImageUrl', headImageUrl)
          ..add('accountBalance', accountBalance)
          ..add('musicNoteNum', musicNoteNum)
          ..add('musicStoneNum', musicStoneNum)
          ..add('studentNum', studentNum)
          ..add('teachingNum', teachingNum)
...
class UserBuilder implements Builder<User, UserBuilder> {
  ...
  String get headImageUrl => _$this._headImageUrl;
  set headImageUrl(String headImageUrl) => _$this._headImageUrl = headImageUrl;
  ...
  int _musicNoteNum;
  int get musicNoteNum => _$this._musicNoteNum;
  set musicNoteNum(int musicNoteNum) => _$this._musicNoteNum = musicNoteNum;

  int _musicStoneNum;
  int get musicStoneNum => _$this._musicStoneNum;
  set musicStoneNum(int musicStoneNum) => _$this._musicStoneNum = musicStoneNum;

  int _studentNum;
  int get studentNum => _$this._studentNum;
  set studentNum(int studentNum) => _$this._studentNum = studentNum;

  int _teachingNum;
  int get teachingNum => _$this._teachingNum;
  set teachingNum(int teachingNum) => _$this._teachingNum = teachingNum;

  String _alipayAccount;
  String get alipayAccount => _$this._alipayAccount;
  set alipayAccount(String alipayAccount) =>
      _$this._alipayAccount = alipayAccount;
  ...
  UserBuilder get _$this {
    if (_$v != null) {
      ...
      _headImageUrl = _$v.headImageUrl;
      _accountBalance = _$v.accountBalance;
      _musicNoteNum = _$v.musicNoteNum;
      _musicStoneNum = _$v.musicStoneNum;
      _studentNum = _$v.studentNum;
      _teachingNum = _$v.teachingNum;
      _alipayAccount = _$v.alipayAccount;
      _$v = null;
    }
    return this;
  }
  ...
  _$User build() {
    final _$result = _$v ??
        new _$User._(
            ...
            musicNoteNum: musicNoteNum,
            musicStoneNum: musicStoneNum,
