...
//       );
  ...
  ThemeData get light => _baseLight.copyWith(
        ...
        bottomAppBarTheme: BottomAppBarTheme(color: ThemeData.light().scaffoldBackgroundColor),
        tabBarTheme: TabBarTheme(
          labelColor: Colors.black,
        ),
        primaryColor: Colors.black,
  ...
  Color get secondColor => firstColor.computeLuminance() >= 0.5 ? Colors.black : Colors.white;
}
