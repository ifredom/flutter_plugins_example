...
class DisconnectedBleDevice extends BleDevice {
  ...
  DisconnectedBleDevice(String name, String id, Peripheral peripheral) : super(name ?? "", id, peripheral);
...
class ConnectedBleDevice extends BleDevice {
  ConnectedBleDevice(String name, String id, Peripheral peripheral) : super(name ?? "", id, peripheral);
